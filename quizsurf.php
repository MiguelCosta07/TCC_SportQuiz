<?php
    ...
    $esporte_id = 3;  // id para Surfe (ajuste conforme seu banco de dados)
    ...
    // Consulta para selecionar as perguntas de Surfe com base na dificuldade
