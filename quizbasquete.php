...
$esporte_id = 2; // id para Basquete (ajuste conforme seu banco de dados)
...
// Consulta para selecionar as perguntas de Basquete com base na dificuldade
...
<body class="quiz-body">
    <header class="quiz-cabec">
        <h1 class="quiz-tit">Quiz de Basquete</h1>
    </header>
